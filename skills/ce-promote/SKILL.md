...
```bash
the ce-promote skill                                   # Derive what shipped from context, draft defaults
the ce-promote skill [free-form description]           # You describe what shipped
the ce-promote skill a tweet thread and a LinkedIn post   # Request specific channels
the ce-promote skill 3 tweet options for the new export feature
```
...
> User: the ce-promote skill 3 tweet options for the new one-click CSV export`
...
> User: the ce-promote skill draft a launch across X, LinkedIn, and email`
