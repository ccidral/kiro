...
- **Implementation-guidance** — run in parallel:
  ...
  - Use the use_subagent tool to delegate to the ce-framework-docs-researcher agent: planning context summary, with exact frameworks/versions from Phase 1.1 where available
