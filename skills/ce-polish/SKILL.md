---
name: ce-polish
description: "Start the dev server, open the feature in a browser, and iterate on improvements together. Manual invocation only — type the ce-polish skill to run it."
